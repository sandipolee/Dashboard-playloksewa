  ...
  return (
    <div className="p-8 flex-1 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {/* Create New Set Card */}
        <Link to="/model-sets/create" className="group flex flex-col items-center justify-center p-6 border-2 border-dashed border-outline-variant/40 rounded-2xl bg-surface-container-low/50 hover:bg-surface-container-highest hover:border-primary/50 transition-all min-h-[280px] cursor-pointer">
